...
import model.importer.threecolumn.ThreeColumnTerrainImporter;
...
public class TerrainGeneratorApplication extends BasicLoggedApplication {
    ...
    public void start() {
        ...
        this.session.getEventBus().register(new ThreeColumnTerrainImporter(this.session), ImportTerrainEvent.class);
